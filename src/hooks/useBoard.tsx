...
export const useBoard = () => {
    ...
    function handleClick(event: React.MouseEvent, curPiece: Piece, valid: boolean = false) { 
        if (valid) {
            ...
            if (activePiece!.type === PieceType.Pawn && activePiece!.position.x === curPiece.position.x && Math.abs(activePiece!.position.y - curPiece.position.y) === 2) {
