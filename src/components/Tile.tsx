...
function Tile({
  ...
  return (
    ...
    >
      ...
      {rowLabel && (
        <p
          className={`opaciy-80 absolute left-1 top-0.5 text-sm font-semibold sm:text-base xl:text-xl ${textColor}`}
        >
          {rowLabel}
        </p>
      )}
      {colLabel && (
        <p
          className={`opaciy-80 absolute right-1 bottom-0.5 text-sm font-semibold sm:text-base xl:text-xl ${textColor}`}
        >
          {colLabel}
        </p>
      )}
