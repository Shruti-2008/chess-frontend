...
function Navigation({
  ...
  const btnNavigationStyle =
    "text-4xl lg:text-4xl xl:text-4xl from-amber-400 to-amber-200 bg-gradient-to-t p-2 rounded-xl font-semibold shadow-lg transition duration-300 hover:ring-4 hover:ring-amber-200 hover:ring-offset-2 hover:ring-offset-amber-200";
